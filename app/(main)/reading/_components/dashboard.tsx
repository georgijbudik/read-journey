...
const Dashboard = () => {
  ...
  return (
    <form className="md:mr-10">
      ...
      <Button
        type="submit"
        className="text-sm mb-10 text-primary bg-transparent py-2.5 border border-[rgba(249,249,249, 0.2)] rounded-[30px] lg:text-base lg:py-3"
      >
        To start
      </Button>
    </form>
